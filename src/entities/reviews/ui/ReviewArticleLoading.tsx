...
export default function ReviewArticleLoading() {
  return (
    <section className="flex flex-col-reverse md:flex-row md:justify-between rounded-md md:rounded-none overflow-hidden shadow-xl shadow-gray-500 md:shadow-none md:px-4 md: border-b-2 md:border-gray-400 md:pb-6">
