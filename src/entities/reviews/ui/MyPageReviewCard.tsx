...
export default function MyPageReviewCard({card, isAuthor, context, priority}: Props) {
  ...
  return (
    <article className="relative bg-white rounded-xl pt-4 w-[310px] h-[400px] md:w-[300px] md:h-[400px] lg:w-[260px] lg:h-[350px] shadow-md shadow-mediumBlue hover:translate-y-[-2px] hover:shadow-lg hover:shadow-boldBlue transition-all">
      {isPending && (
